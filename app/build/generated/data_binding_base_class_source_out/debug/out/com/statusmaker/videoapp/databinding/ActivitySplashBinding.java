...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivSplashLogo,
      @NonNull LottieAnimationView lottieLoading, @NonNull TextView tvAppName,
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, ivSplashLogo, lottieLoading,
          tvAppName, tvTagline);
    }
